<?php 
	...
	$query     = $modal->_fetch_total_bookmark();
	...
	$query 	   = $modal->_fetch_bookmark(array('limit'  => $count->count > 10 ? $_GET['limit'] : 10,'offset' => $count->count > 10 ? 0 : $_GET['offset'] == "" ? 0 : $_GET['offset'] < 0 ? $_GET['offset'] = 0 : $_GET['offset']));
